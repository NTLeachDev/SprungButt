...
public class ConfiguredBeanMetadataa<T> extends Metadataa<T> {
    private final Method method;
    private final Dependency[] dependencies;
    private final ConfigBeanMetadataa<?> parentConfigMetadata;

    public ConfiguredBeanMetadataa(final Class<T> type, final String beanName, final Method method, final Dependency[] dependencies, final ConfigBeanMetadataa<?> parentConfigMetadata) {
    ...
    public ConfiguredBeanMetadataa(final BeanMethod<T> beanMethod, final ConfigBeanMetadataa<?> parentConfigMetadata) {
        this(beanMethod.getReturnType(), beanMethod.getBeanName(), beanMethod.getMethod(), beanMethod.getDependencies(), parentConfigMetadata);
    }
    ...
    public ConfigBeanMetadataa<?> getParentConfigMetadata() {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ConfiguredBeanMetadataa)) {
            return false;
        }
        if (!super.equals(o)) {
            return false;
        }
        final ConfiguredBeanMetadataa<?> that = (ConfiguredBeanMetadataa<?>) o;
    ...
    public String toString() {
        return new StringJoiner(", ", ConfiguredBeanMetadataa.class.getSimpleName() + "[", "]")
                .add("method=" + method)
